...
HD_PWD='C:/Users/selfd/tic_tac_toe/tic_tac_toe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gameLogic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gameLogic.tcl -notrace
