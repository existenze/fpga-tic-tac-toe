...
HD_PWD='C:/Users/selfd/tic_tac_toe/tic_tac_toe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gameLogic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gameLogic.tcl
